...
const Color redColor = Color.fromRGBO(24, 119, 242, 1);
// const Color redColor = Color.fromRGBO(230, 46, 4, 1);
const Color blueColor =
    Color.fromRGBO(24, 119, 242, 1); //Color.fromRGBO(r, b, opacity)
// const Color blueColor = Color.fromRGBO(230, 46, 4, 1);
const Color golden = Color.fromRGBO(255, 168, 0, 1);
const Color lightGolden = Color.fromRGBO(255, 248, 207, 1);
